                ...
                <div className="sensor-list">
                    {
                        this.state.sensors.map((sensor, index) => (
                            <div key={index} className="sensor-list-item">
                                <SensorChart title={sensor.Name} label={this.state.sensorType} data={sensor.chart.data} labels={sensor.chart.labels} maxAt={sensor.chart.maxAt} minRange={sensor.chart.minRange} maxRange={sensor.chart.maxRange} unit={sensor.chart.unit} color="#D0D0D0"/>
                            </div>
                        ))
                    }
                </div>
